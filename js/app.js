(() => {
  ...
  document.querySelectorAll(".slider-clinic").forEach(function (clinicSlider) {
    let splideParent = document.createElement("div");
    splideParent.className = "splide";
    splideParent.setAttribute("data-parent-slider", "");
    ...
    clinicSlider
      .querySelectorAll(".slider-clinic__item")
      .forEach(function (item) {
        let splideSlide = document.createElement("li");
        splideSlide.className = "splide__slide";
        let container = document.createElement("div");
        container.className = "slider-clinic__container";
        let splideChild = document.createElement("div");
        splideChild.className = "splide";
        splideChild.setAttribute("data-child-slider", "");
        let splideChildArrows = document.createElement("div");
        splideChildArrows.className = "splide__arrows";
        let prevButton = document.createElement("button");
        prevButton.className = "splide__arrow splide__arrow--prev";
        prevButton.innerHTML = `\n      <svg viewBox="0 0 24 12" fill="none">\n        <path fill-rule="evenodd" clip-rule="evenodd"\n          d="M0.154663 5.99998L5.25673 0.331016L6.74332 1.66895L3.74539 4.99998L23.5 4.99998L23.5 6.99998L3.74539 6.99998L6.74332 10.331L5.25673 11.6689L0.154663 5.99998Z"\n          fill="#005AA6" />\n      </svg>\n      prev\n    `;
        let nextButton = document.createElement("button");
        nextButton.className = "splide__arrow splide__arrow--next";
        nextButton.innerHTML = `\n      next\n      <svg viewBox="0 0 24 12" fill="none">\n        <path fill-rule="evenodd" clip-rule="evenodd"\n          d="M0.154663 5.99998L5.25673 0.331016L6.74332 1.66895L3.74539 4.99998L23.5 4.99998L23.5 6.99998L3.74539 6.99998L6.74332 10.331L5.25673 11.6689L0.154663 5.99998Z"\n          fill="#005AA6" />\n      </svg>\n    `;
        let pagination = document.createElement("ul");
        pagination.className = "splide__pagination";
        splideChildArrows.appendChild(prevButton);
        splideChildArrows.appendChild(pagination);
        splideChildArrows.appendChild(nextButton);
        let splideChildTrack = document.createElement("div");
        splideChildTrack.className = "splide__track";
        let splideChildList = document.createElement("ul");
        splideChildList.className = "splide__list";
        item
          .querySelectorAll(".slider-clinic__images img")
          .forEach(function (img) {
            let splideChildSlide = document.createElement("li");
            splideChildSlide.className = "splide__slide";
            splideChildSlide.appendChild(img);
            splideChildList.appendChild(splideChildSlide);
          });
        splideChildTrack.appendChild(splideChildList);
        splideChild.appendChild(splideChildArrows);
        splideChild.appendChild(splideChildTrack);
        let logo = document.createElement("div");
        logo.className = "logo";
        let logoImg = document.createElement("img");
        logoImg.className = "ibg ibg--contain";
        logoImg.src = "img/logo.svg";
        logoImg.alt = "logo";
        logo.appendChild(logoImg);
        splideChild.appendChild(logo);
        container.appendChild(splideChild);
        let textBlock = item.querySelector(".slider-clinic__text");
        container.appendChild(textBlock);
        splideSlide.appendChild(container);
  ...
  document
    .querySelectorAll("[data-parent-slider]")
    .forEach(function (parentSplide, parentIndex) {
      ...
      parentSplide
        .querySelectorAll("[data-child-slider]")
        .forEach(function (slider) {
          ...
          var isParentAtStart = splideParent.index === 0;
          var isParentAtEnd = splideParent.index === splideParent.length - 1;
          var isChildAtStart =
            childSlider.index === 0 || childSlider.length === 1;
          var isChildAtEnd =
            childSlider.index === splideParent.length - 1 ||
            childSlider.length === 1;
          function updateParentState(newIndex) {
            isParentAtStart = newIndex === 0;
            isParentAtEnd = newIndex === splideParent.length - 1;
          }
          function updateChildState(newIndex) {
            isChildAtStart = newIndex === 0;
            isChildAtEnd = newIndex === childSlider.length - 1;
          }
          function updateButtonState() {
            ...
            else if (isChildAtStart) prevButton.setAttribute("disabled", "");
            if (!isParentAtEnd)
              if (isChildAtEnd) {
                nextButton.removeAttribute("disabled");
                nextButton.setAttribute("data-parent-next", "");
              } else nextButton.removeAttribute("data-parent-next");
            else if (isChildAtEnd) nextButton.setAttribute("disabled", "");
          }
          updateButtonState();
          childSlider.on("moved", function () {
            updateChildState(childSlider.index);
            updateButtonState();
          });
          ...
          nextButton.addEventListener("click", function () {
            if (nextButton.hasAttribute("data-parent-next"))
              splideParent.go("+1");
          });
          prevButton.addEventListener("click", function () {
            if (prevButton.hasAttribute("data-parent-prev"))
              splideParent.go("-1");
          });
        });
    });
