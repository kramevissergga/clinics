 ...
 */    var MEDIA_PREFERS_REDUCED_MOTION = "(prefers-reduced-motion: reduce)";
    ...
    document.querySelectorAll(".slider-clinic").forEach((function(clinicSlider) {
        ...
        clinicSlider.querySelectorAll(".slider-clinic__item").forEach((function(item) {
            ...
            item.querySelectorAll(".slider-clinic__images img").forEach((function(img) {
            ...
            splideChild.appendChild(clinicSlider.querySelector(".logo").cloneNode(true));
        ...
        clinicSlider.querySelector(".logo").remove();
    ...
    document.querySelectorAll("[data-parent-slider]").forEach((function(parentSplide, parentIndex) {
        ...
        parentSplide.querySelectorAll("[data-child-slider]").forEach((function(slider) {
            ...
            var isChildAtStart = childSlider.index === 0 || childSlider.length === 1;
            var isChildAtEnd = childSlider.index === splideParent.length - 1 || childSlider.length === 1;
            ...
            prevButton.addEventListener("click", (function() {
                if (prevButton.hasAttribute("data-parent-prev")) splideParent.go("-1");
            }));
        }));
    }));
